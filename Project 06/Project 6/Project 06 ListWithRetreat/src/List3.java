...
public class List3<T> extends ListSecondary<T> {
    ...
    public final void addRightFront(T x) {
        ...
        //the new node to be added to the front of right
        Node added = new Node();
        added.data = x;
        //linking to the old front and lastleft
        added.next = this.lastLeft.next;
        added.previous = this.lastLeft;
        //linking .previous of the old front to the new front
        this.lastLeft.next.previous = added;
        //linking last left to the new front
    ...
    public final T removeRightFront() {
        ...
        //removing all links to the current front that is being removed
    ...
    public final void advance() {
        ...
        Node newLast = this.lastLeft.next;
        this.rightLength--;
    ...
    public final void moveToStart() {
        ...
        //right now starts at "index 1", the one after prestart("index 0")
        this.lastLeft = this.preStart;
    ...
    public final void retreat() {
        ...
        Node newLastLeft = this.lastLeft.previous;
        this.leftLength--;
