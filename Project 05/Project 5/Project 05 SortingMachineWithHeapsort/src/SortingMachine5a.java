...
public class SortingMachine5a<T> extends SortingMachineSecondary<T> {
    ...
    private static <T> void siftDown(T[] array, int top, int last,
        ...
        // Initialize left and the right subtrees
        int left = 2 * top + 1;
        int right = 2 * top + 2;

        /*
         * if left is the last heap, then compare it to top and if it's smaller,
         * then sift down
         */
        if (left == last) {
            ...
            /*
             * if left is smaller then last, then compare the root of the left
             * to the root of the right. if left root is smaller, then exchange
             * it with top, and then sift down.
             */
            if (order.compare(array[left], array[right]) < 0) {
                ...
                // else, right root is smaller than top, then do the same thing above.
    ...
    private static <T> void heapify(T[] array, int top, Comparator<T> order) {
        ...
        /*
         * if left is smaller than length of the array, that means there is a
         * left subtree, so heapify the left tree.
         */
        ...
        /*
         * if right is smaller than length of the array, that means there is a
         * right subtree, so heapify the right tree.
         */
    ...
    public final T removeFirst() {
        ...
        // Exchange entries at first position, with the last node
