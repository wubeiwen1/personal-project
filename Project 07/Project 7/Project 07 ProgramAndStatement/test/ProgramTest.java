 ...
 *
 * @author Wayne Heym
 * @authorZheng Ji Tan(tan.955) & Beiwen Wu(wu.4742) & ZheHui Li(li.8908)
 *
 */
public abstract class ProgramTest {
    ...
    private static final String PROGRAM_EMPTY = "data/program-empty.bl";
    ...
    public final void testEmptyProg() {
         ...
         * Setup
         */
        Program pTest = this.createFromFileTest(PROGRAM_EMPTY);
        Program pRef = this.createFromFileRef(PROGRAM_EMPTY);
        /*
         * The call
         */
        String result = pTest.name();
    ...
    @Test
    public final void testSetNameA() {
        /*
         * Setup
         */
        Program pTest = this.createFromFileTest(FILE_NAME_1);
    ...
    @Test
    public final void testSetNameLong() {
        /*
         * Setup
         */
        Program pTest = this.createFromFileTest(FILE_NAME_1);
        Program pRef = this.createFromFileRef(FILE_NAME_1);
        String newName = "ASDAEGEQNATRJRWM-6541adsasd---EafQeewgWer2QF2";
        pRef.setName(newName);
        /*
         * The call
         */
