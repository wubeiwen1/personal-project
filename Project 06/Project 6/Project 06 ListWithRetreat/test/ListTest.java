...
public abstract class ListTest {
    ...
    /*
     ********************** Test cases for Retreat methods*********************
     */
    @Test // boundary case
    ...
    @Test // boundary case
    public final void testRetreatLeftNotEmptyRight1() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(2, "ab", "bc", "cd");
        List<String> list2 = this.createFromArgsRef(1, "ab", "bc", "cd");
        /*
         * Call method under test
         */
        list1.retreat();
    ...
    @Test // routine case
    public final void testRetreatLeft1RightNotEmpty() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(1, "ab", "bc", "cd", "de",
                "ef", "fg");
        List<String> list2 = this.createFromArgsRef(0, "ab", "bc", "cd", "de",
                "ef", "fg");
        /*
         * Call method under test
         */
    ...
    @Test // routine case
    public final void testRetreatLeftNotEmptyRightNotEmpty() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(3, "ab", "bc", "cd", "de",
                "ef", "fg");
        List<String> list2 = this.createFromArgsRef(2, "ab", "bc", "cd", "de",
                "ef", "fg");
        /*
         * Call method under test
         */
